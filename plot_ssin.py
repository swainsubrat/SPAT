"""
This file is created to plot the SSIN scores of recon, old and new attacks
with the original images. Let's do this and delete afterwards
"""
import yaml
import time
import torch
...
def compute_ssim(images_1: List[Tensor], images_2: List[Tensor]):
    """
    Take a set of two image lists and
    compute ssim scores between them.
...
recon_images = autoencoder_model(images)[0]
...
ssim_scores["orig_adv_images"] = compute_ssim(images, orig_attack_adv_images)
ssim_scores["modified_adv_images"] = compute_ssim(images, modified_attack_adv_images)
